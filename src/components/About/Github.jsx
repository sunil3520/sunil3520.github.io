  ...
  return (
    <>
      ...
      <Flex gap={10} flexDirection={isSmallerThen ? "column" : "row"}>
        <HStack>
          <Image src="https://github-readme-streak-stats.herokuapp.com?user=sunil3520" width={390} />
        </HStack>
        <HStack>
          <Image src="https://github-readme-stats.vercel.app/api?username=sunil3520" width={390}/>
        </HStack>
      </Flex>
    </>
  );
